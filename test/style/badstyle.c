...
int big_line(int longVariableName, long *variableName, double twiceAsLong,
             float whenWillItEnd, long anotherOne) {
  int after_tab = 99;
  anotherOne = (int)twiceAsLong + longVariableName + *variableName +
               twiceAsLong + whenWillItEnd + anotherOne + 3.14159265;
