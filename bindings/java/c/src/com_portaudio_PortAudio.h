...
#define com_portaudio_PortAudio_HOST_API_TYPE_COUNT 15L
     ...
     * Signature: ()I
     */
    JNIEXPORT jint JNICALL Java_com_portaudio_PortAudio_getVersion( JNIEnv *, jclass );
     ...
     */
    JNIEXPORT jstring JNICALL Java_com_portaudio_PortAudio_getVersionText( JNIEnv *, jclass );
     ...
     * Signature: ()V
     */
    JNIEXPORT void JNICALL Java_com_portaudio_PortAudio_initialize( JNIEnv *, jclass );
     ...
     * Signature: ()I
     */
    JNIEXPORT jint JNICALL Java_com_portaudio_PortAudio_getDeviceCount( JNIEnv *, jclass );
     ...
     * Signature: ()I
     */
    JNIEXPORT jint JNICALL Java_com_portaudio_PortAudio_getHostApiCount( JNIEnv *, jclass );
     ...
     * Signature: ()I
     */
    JNIEXPORT jint JNICALL Java_com_portaudio_PortAudio_getDefaultInputDevice( JNIEnv *, jclass );
     ...
     * Signature: ()I
     */
    JNIEXPORT jint JNICALL Java_com_portaudio_PortAudio_getDefaultOutputDevice( JNIEnv *, jclass );
     ...
     * Signature: ()I
     */
    JNIEXPORT jint JNICALL Java_com_portaudio_PortAudio_getDefaultHostApi( JNIEnv *, jclass );
